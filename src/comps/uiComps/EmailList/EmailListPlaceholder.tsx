const EmailListPlaceholder = () => {
  return (
    <div className="animate-pulse flex gap-x-3 p-4">
      <div className="flex justify-center items-center h-8 w-8 bg-gray-300 dark:bg-gray-700 rounded-full">
        <svg
      ...
      <div className="w-full">
        ...
        <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-1/3 mb-2.5" />
