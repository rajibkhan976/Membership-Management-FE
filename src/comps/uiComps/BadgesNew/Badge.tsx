...
const Badge: React.FC<BadgeProps1> = ({
  label = 'Free',
  className = '',
  size = 'sm',
  variant = 'primary',
  ...
  return <span className={`inline-flex items-center text-xs font-semibold leading-4 ${btnCls}`}>{label}</span>
}
