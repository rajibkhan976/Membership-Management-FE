...
function SkeletonCard(props: SkeletonCardProps) {
  ...
  return (
    ...
    >
      <div className="flex justify-center items-center  h-[202px] bg-gray-300  dark:bg-gray-700">
        <svg
      ...
      <div className="px-4 py-2 mb-3 ">
        <div className="flex items-center space-x-3 mb-3 h-[49px]">
          <svg
          ...
          <div>
            <div className="h-2.5 bg-gray-300 rounded-full dark:bg-gray-700 w-32 mb-2" />
            {/* <div className="w-48 h-2 bg-gray-200 rounded-full dark:bg-gray-700" /> */}
          </div>
        </div>
        <div className="!h-[186px]">
          <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5 w-36" />
