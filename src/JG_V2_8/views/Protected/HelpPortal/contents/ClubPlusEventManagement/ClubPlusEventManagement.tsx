...
const HOW_TO_VIDEOES_GENERAL = {
  ...
  description: 'A guide to setting up Membership account in order to start managing member memberships',
  ytEmbedLink: 'https://www.youtube.com/embed/NEiPN__0oMs',
}

const ClubPlusEventManagement = () => {
  return <HelpPortalItem videoData={HOW_TO_VIDEOES_GENERAL} />
}
export default ClubPlusEventManagement
