...
const HOW_TO_VIDEOES_GENERAL = {
  ...
  description: "This tutorial will show you how to create a Stripe Express account so that you and your fellow administrators can begin accepting payments.",
