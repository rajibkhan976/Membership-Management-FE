...
import IndeterminateCheckbox from '../../leftFilterBar/IndeterminateCheckbox'
import classNames from 'classnames'
import FancyScroll from '@jg/common/comps/Scrollbar/FancyScroll'
import { WithCategoryFilterOptions } from '../../leftFilterBar/EventFilterOptionCategory'
import useNavigateWithArgsMB from '../../hooks/useNavigateWithArgsMB'

/*{const MyBookingOptionCategoryItem = ({
  checked = false,
  isSubCategory = false,
  label,
  eventCount,
    ...
    >
      <IndeterminateCheckbox
        ...
        caption={
          <>
            {label}
            {!isSubCategory && <span className="block text-jg-grey-500 ">{eventCount} events</span>}
...
export default MyBookingOptionCategory*/
